...
export default function details() {
  ...
  const message = `Olá, ${incident.name}, estou interessado em ajudar no caso: ${incident.title} com o valor de ${incident.value}`;
  incident = {
    ...incident,
      ...
      <View style={styles.contactBox}>
        ...
        <View style={styles.actions}>
          <TouchableOpacity style={styles.action} onPress={sendWhatsapp}>
            <Text style={styles.textActionText}>WhatsApp</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.action} onPress={sendMail}>
            <Text style={styles.textActionText}>E-Mail</Text>
          </TouchableOpacity>
        </View>
      </View>
    </View>
